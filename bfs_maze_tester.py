...
def test_moves():
    assert test_moves1() == True
    assert test_moves2() == True
    assert test_moves3() == True
    assert test_moves4() == True
...
def test_neighbor():
    assert test_neighbor1() == True
    assert test_neighbor2() == True
    assert test_neighbor3() == True
